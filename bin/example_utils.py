...
def setup(base_url=None, skip_ws=False, perp_dexs=None, vault_address=None):
    ...
    exchange = Exchange(account, base_url, account_address=address, perp_dexs=perp_dexs, vault_address=vault_address)
